...
/variable {PETSVERSION} {1.00} {PETS_100}
/variable {PETSRELEASE} {October 26, 2012} {PETS_100}

/alias {petsid %1, %2, %3, %4, %5, %6} {clearpets;/var Pet1 $1;/var Pet2 $2;/var Pet3 $3;/var Pet4 $4;/var Pet5 $5;/var Pet6 $6;showpets}  {PETS_100}
...
/alias {clearpetid1} {/empty Pet1} {PETS_100}
/alias {clearpetid2} {/empty Pet2} {PETS_100}
/alias {clearpetid3} {/empty Pet3} {PETS_100}
/alias {clearpetid4} {/empty Pet4} {PETS_100}
/alias {clearpetid5} {/empty Pet5} {PETS_100}
/alias {clearpetid6} {/empty Pet6} {PETS_100}
/alias {petsshow} {emote $Pet1,$Pet2,$Pet3,$Pet4,$Pet5,$Pet6} {PETS_100}
/alias {petsclear} {/empty Pet1;/empty Pet2;/empty Pet3;/empty Pet4;/empty Pet5;/empty Pet6} {PETS_100}

/alias {petsbuysetup} {/var Pet1 DW1;/var Pet2 DW2;/var Pet3 DW3;/var Pet4 DW4;/var Pet5 DW5;/var Pet6 DW6} {PETS_100}
/alias {buyliz} {buy lizzard DW1;buy lizzard DW2;buy lizzard DW3;buy lizzard DW4;buy lizzard DW5;buy lizzard DW6;petsbuysetup} {PETS_100}
/alias {buybears} {buy bear DW1;buy bear DW2;buy bear DW3;buy bear DW4;buy bear DW5;buy bear DW6;petsbuysetup} {PETS_100}
...
/alias {petshelp} {/showme {@Chr(10)@AnsiReset()@AnsiBold()@ForeCyan()Commands          @ForeBlue()- - - - - - - - -  @ForeCyan()What they do...@Chr(10)@ForeBlue()---------------------------------------------------------------------------------------------------@Chr(10)@ForeCyan()petshelp            @ForeBlue()- - - - - - - - -  @ForeCyan()This listing@Chr(10)petsid 1, 2, 3, 4, 5, 6  @ForeBlue()- - - - - - - - -  @ForeCyan()Set all 6 pet names to use at once @Chr(10)petid1              @ForeBlue()- - - - - - - - -  @ForeCyan()Set Pet1 name to use @Chr(10)petid2              @ForeBlue()- - - - - - - - -  @ForeCyan()Set Pet2 name to use @Chr(10)petid3              @ForeBlue()- - - - - - - - -  @ForeCyan()Set Pet3 name to use @Chr(10)petid4              @ForeBlue()- - - - - - - - -  @ForeCyan()Set Pet4 name to use @Chr(10)petid5              @ForeBlue()- - - - - - - - -  @ForeCyan()Set Pet5 name to use @Chr(10)petid6              @ForeBlue()- - - - - - - - -  @ForeCyan()Set Pet6 name to use @Chr(10)clearpetid1         @ForeBlue()- - - - - - - - -  @ForeCyan()Clear Pet1 name @Chr(10)clearpetid2         @ForeBlue()- - - - - - - - -  @ForeCyan()Clear Pet2 name @Chr(10)clearpetid3         @ForeBlue()- - - - - - - - -  @ForeCyan()Clear Pet3 name @Chr(10)clearpetid4         @ForeBlue()- - - - - - - - -  @ForeCyan()Clear Pet4 name @Chr(10)clearpetid5         @ForeBlue()- - - - - - - - -  @ForeCyan()Clear Pet5 name @Chr(10)clearpetid6         @ForeBlue()- - - - - - - - -  @ForeCyan()Clear Pet6 name @Chr(10)petsshow            @ForeBlue()- - - - - - - - -  @ForeCyan()Display configured pet names @Chr(10)petsclear           @ForeBlue()- - - - - - - - -  @ForeCyan()Clear configured pet names @Chr(10)@Chr(10)buyliz              @ForeBlue()- - - - - - - - -  @ForeCyan()buy 6 lizards @Chr(10)buybears            @ForeBlue()- - - - - - - - -  @ForeCyan()buy 6 bears @Chr(10)@Chr(10)restpets            @ForeBlue()- - - - - - - - -  @ForeCyan()make all pets rest @Chr(10)standpets           @ForeBlue()- - - - - - - - -  @ForeCyan()make all pets stand @Chr(10)sleeppets           @ForeBlue()- - - - - - - - -  @ForeCyan()make all pets sleep @Chr(10)wakepets            @ForeBlue()- - - - - - - - -  @ForeCyan()make all pets wake @Chr(10)@Chr(10)petsabout           @ForeBlue()- - - - - - - - -  @ForeCyan()Displays information about Pets @Chr(10)petsversion         @ForeBlue()- - - - - - - - -  @ForeCyan()Displays Current Pets Version@Chr(10)@AnsiReset()}} {PETS_100}
